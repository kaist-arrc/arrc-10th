...
- 행사일: 2026년 9월 1일 (화) 13:00 - 17:00
- 장소: KAIST KI빌딩(E4) 2층 매트릭스홀
...
**줄 수만 주의하세요.** 두 목록은 열 수가 고정되어 있습니다.

| 목록 | 클래스 | 열 수 | 현재 |
| --- | --- | --- | --- |
| 후원 | `orgs__list--3` | 3 | 6곳 = 두 줄 |
| 협력 기관 | `orgs__list--6` | 6 | 12곳 = 두 줄 |

기관 수가 열 수의 배수가 아니면 마지막 줄이 비게 됩니다. 그럴 때는
`style.css` 의 `.orgs__list--3` / `.orgs__list--6` 열 수를 함께 바꿔 주세요.
(좁은 화면에서는 각각 2열 / 3열로 자동으로 접힙니다.)
